  ...
  return (
    ...
    >
      <div className="relative aspect-[3/4] overflow-hidden bg-black/5 dark:bg-white/5">
        ...
        {/* Floating Badges (Stacked on left to prevent clashing on mobile) */}
      ...
      <div className="p-2 sm:p-3 flex flex-col gap-1 flex-1 relative z-10 bg-gradient-to-b from-transparent to-white/10 dark:to-black/10">
        <h3 className="font-heading font-bold text-sm sm:text-base leading-tight line-clamp-2 min-h-[2.25rem] sm:min-h-[2.5rem] md:group-hover:text-accent active:text-accent transition-colors duration-300">
          {novel.title}
        </h3>
